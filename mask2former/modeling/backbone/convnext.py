...
class D2ConvNext(ConvNeXt, Backbone):
    def __init__(self, cfg, input_shape):
        ...
        embed_dims = cfg.MODEL.CONVNEXT.EMBED_DIM
        drop_path_rate = cfg.MODEL.CONVNEXT.DROP_PATH_RATE  # put in config.py
        layer_scale_init_value = cfg.MODEL.CONVNEXT.LAYER_SCALE_INIT_VALUE
        out_indices = cfg.MODEL.CONVNEXT.OUT_INDICES  # put in config.py
