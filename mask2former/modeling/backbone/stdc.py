        ...
        for i, layer in enumerate(layers):
            for j in range(layer):
                if i == 0 and j == 0:
                    ...
                    features.append(block(base * int(math.pow(2, i + 1)), base * int(math.pow(2, i + 2)), block_num, 2, norm_layer))
                else:
                    features.append(block(base * int(math.pow(2, i + 2)), base * int(math.pow(2, i + 2)), block_num, 1, norm_layer))
